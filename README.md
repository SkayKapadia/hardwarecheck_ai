...
- **Hardware Selection:** 23 GPU targets — from RTX 3060/4090/5090 to A100/H100/H200/B200, AMD MI300X, and Apple Silicon (M3 Max through M5 Max, Mac Mini M6 / M5 Pro) — including multi-GPU tensor-parallel arrays with per-card splits and CPU-offload planning (VRAM and system RAM as separate pools).
