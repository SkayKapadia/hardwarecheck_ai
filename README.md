...
- **Hardware Selection:** 25 GPU targets — from RTX 3060/4090/5090 to A100/H100/H200/B200, AMD MI300X, and Apple Silicon (M3 Max through M5 Ultra, incl. Mac Mini and Mac Studio) — including multi-GPU tensor-parallel arrays with per-card splits and CPU-offload planning (VRAM and system RAM as separate pools).
